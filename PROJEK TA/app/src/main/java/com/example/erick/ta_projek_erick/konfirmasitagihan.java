...
public class konfirmasitagihan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        View view = inflater.inflate(R.layout.activity_konfirmasitagihan, parent, false);


        Toolbar toolbar = view.findViewById(R.id.toolbar);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Konfirmasi Pembayaran");
        ((AppCompatActivity) getActivity()).getSupportActionBar().setLogo(R.drawable.ic_action_money);


        textNamacust = (TextView) view.findViewById(R.id.TxNamaCust);
        ...
        final ArrayList<HashMap<String, String>> data = cnt.konfirmasiTagihan();
